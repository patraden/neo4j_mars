...
# CA password for .psx file should be given as parameter to docker build --build-arg CERRTIFICATE_PASSWORD='password'
...
# Enabling relevant virtual hosts configurations
